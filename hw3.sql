...
SELECT country
FROM country
WHERE country LIKE '%_____n'; -- The underscore only replaces one character.


/* 3)In the title column of the movie table, list the movie names containing at least 4 'T' characters, 
regardless of upper or lower case letters. */
